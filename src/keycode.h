...
enum _MMKeyCode {
	...
	K_VOLUMEMUTE = VK_VOLUME_MUTE,
	K_VOLUMEDOWN = VK_VOLUME_DOWN,
	K_VOLUMEUP = VK_VOLUME_UP,
	K_NEXTTRACK = VK_MEDIA_NEXT_TRACK,
	K_PREVTRACK = VK_MEDIA_PREV_TRACK,
	K_STOP = VK_MEDIA_STOP,
	K_PLAYPAUSE = VK_MEDIA_PLAY_PAUSE
};
